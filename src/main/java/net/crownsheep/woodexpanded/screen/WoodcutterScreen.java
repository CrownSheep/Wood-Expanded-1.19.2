...
public class WoodcutterScreen extends AbstractContainerScreen<WoodcutterMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(WoodExpended.MOD_ID,"textures/gui/gem_infusing_station_gui.png");

    public WoodcutterScreen(WoodcutterMenu menu, Inventory inventory, Component component) {
