...
public abstract class ModSingleItemRecipe implements Recipe<Container> {
    ...
    public ModSingleItemRecipe(RecipeType<?> pType, RecipeSerializer<?> pSerializer, ResourceLocation pId, String pGroup, Ingredient pIngredient, ItemStack pResult) {
        this.type = pType;
    ...
    public static class Serializer<T extends ModSingleItemRecipe> implements RecipeSerializer<T> {
        final ModSingleItemRecipe.Serializer.SingleItemMaker<T> factory;

        protected Serializer(ModSingleItemRecipe.Serializer.SingleItemMaker<T> pFactory) {
        ...
        interface SingleItemMaker<T extends ModSingleItemRecipe> {
