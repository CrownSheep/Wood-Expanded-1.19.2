package net.crownsheep.woodexpanded.networking.packet;
...
public class ItemStackSyncS2CPacket {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            if(Minecraft.getInstance().level.getBlockEntity(pos) instanceof CarvingStationBlockEntity blockEntity) {
