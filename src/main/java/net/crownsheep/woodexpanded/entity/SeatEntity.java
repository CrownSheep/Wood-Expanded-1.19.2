...
public class SeatEntity extends Entity {
    ...
    public SeatEntity(EntityType<Entity> entityEntityType, Level level) {
    ...
    public static InteractionResult createForPlayer(Level level, BlockPos pos, double yOffset, Player player, Direction direction)
    {
