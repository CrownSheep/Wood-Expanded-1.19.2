package net.crownsheep.tutorialmod.item;

import net.crownsheep.tutorialmod.TutorialMod;
import net.crownsheep.tutorialmod.block.ModBlocks;
import net.crownsheep.tutorialmod.item.custom.EightBallItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> BLUEBERRY = ITEMS.register("blueberry",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(2f).build()).tab(ModCreativeModeTab.TUTORIAL_TAB)));
